...
const Value = () => {
  return (
    <div className="mb-[4rem] mt-[6rem]">
      ...
      <div className="grid gap-[10rem] grid-cols-3 items-center ">
        <div className="singleGrid rounded-[10px] hover:bg-[#eeedf7] p-[1.5rem]">
          ...
          <p className="text-[13px] text-textColor  opacity-[.7] py-[1rem] font-semibold">
            This being made beautiful simple are at the heart of everything we
            do.
          </p>
        </div>
        <div className="singleGrid rounded-[10px] hover:bg-[#f7edf5] p-[1.5rem]">
          <div className="flex items-center gap-3">
            <div className="imgDiv p-[4px] rounded-[.8rem] bg-[#f7d1e1] h-[40px] w-[40px] flex items-center justify-center">
              <img src={React1} alt="" className="w-[70%}" />
            </div>
            <span className="font-semibold text-textColor text-[18px] ">
              Simplicity
            </span>
      ...
      <div className="card mt-[2rem] flex justify-between bg-grey p-[5rem] rounded-[10px]">
        <div>
          <h1 className="text-blueIs text-[30px] font-bold">
        ...
        <button className="border-[2px] rounded-[10px] py-[4px] px-[50px] text-[18px] font-semibold text-blueIs hover:bg-white border-blueIs">
          Get Start
        </button>
      </div>
    </div>
